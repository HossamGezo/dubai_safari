...
const NewsLetterForm = () => {
  ...
  // Return JSX
  return (
    <form className="news-letter-form w-full" onSubmit={handleSubmit(onSubmit)}>
      <InputField
        type="email"
      ...
      <Button
        type="submit"
        className="max-md:w-25 w-37.5 mt-3 max-md:py-1 md:py-2 lg:py-3 rounded-md"
      >
        Sign Up
      </Button>
    </form>
